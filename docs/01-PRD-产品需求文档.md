...
**服务端校验规则（九条，编号与 03-课程与视频 §8.2.1 逐条对应）**

> **规则编号以 03-03 §8.2.1 为准**，本节与 `vod_heartbeat_log.reject_rule` 均引用该套编号，**三处必须一致**。
...
>
> 本节写**业务语义与为什么**；阈值与判定细节（区间、次数、秒数）一律以 03-03 §8.2.1 为准，不在此处重复定义。
