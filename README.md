...
| [scripts/check_consistency.py](scripts/check_consistency.py) | 文档一致性检查（17 项，无依赖）：`python3 scripts/check_consistency.py`，说明见 [scripts/README.md](scripts/README.md) |
